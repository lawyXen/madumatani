                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-12">
                                        <div class="form-floating">
                                            ...
                                            <input class="form-control" id="nama" name="namaalat" placeholder="nama alat" type="text" value="{{ $barang->nama }}"readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-12">
                                        <div class="form-floating">
                                            ...
                                            <input class="form-control" id="nama" name="jumlah" placeholder="Stok" type="number" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-12">
                                        <div class="form-floating">
                                            ...
                                            <input class="form-control" id="rencana peminjaman" name="tanggal_peminjaman" placeholder="rencana peminjaman" type="date">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-12">
                                        <div class="form-floating">
                                            ...
                                            <input class="form-control" id="rencana pemulangan" name="tanggal_pemulangan" placeholder="rencana pemulangan" type="date">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
